...
// chứa thông tin về 1 đơn hàng , gồm danh sach sản phẩm của đơn hàng, và thông tin người mua hàng
public class Orders {
	...
	public Orders(String userMail, int status,Date orderDate, String discount, String address) {
		this.userMail = userMail;
		this.status = status;
		this.orderDate = orderDate;
		this.discount = discount;
